...
exports.default = (0, _utils.createElement)('container', {
  ...
  render(attrs, contents) {
    ...
    return _utils2.default.renderElement(
      'div',
      attrs,
      (0, _utils.condition)('mso | IE', `<table class="container__table__ie" role="presentation" border="0" cellpadding="0" cellspacing="0"><tr><td>`),
      _utils2.default.renderElement(
        'table',
        { 'class': 'container__table', role: 'presentation', border: '0', align: 'center', cellpadding: '0', cellspacing: '0', width: '100%' },
        _utils2.default.renderElement(
          'tr',
          { 'class': 'container__row' },
          _utils2.default.renderElement(
            'td',
            { 'class': 'container__cell', width: '100%', align: 'left', valign: 'top' },
            contents
          )
        )
      ),
